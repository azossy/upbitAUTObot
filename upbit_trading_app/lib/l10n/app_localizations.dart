...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _strings = {
    ...
    'aiStrategyTitle': {'ko': '투자 전략', 'en': 'Investment strategy', 'zh': '投资策略', 'ja': '投資戦略', 'es': 'Estrategia de inversión', 'fr': 'Stratégie d\'investissement', 'de': 'Anlagestrategie', 'pt': 'Estratégia de investimento', 'ru': 'Стратегия', 'ar': 'استراتيجية الاستثمار', 'th': 'กลยุทธ์การลงทุน', 'vi': 'Chiến lược đầu tư', 'id': 'Strategi investasi', 'hi': 'निवेश रणनीति', 'tr': 'Yatırım stratejisi'},
    'aiStrategyProfitFirst': {'ko': '수익성 우선', 'en': 'Profit first', 'zh': '收益优先', 'ja': '収益優先', 'es': 'Rentabilidad primero', 'fr': 'Rentabilité prioritaire', 'de': 'Ertrag zuerst', 'pt': 'Lucro primeiro', 'ru': 'Прибыль в приоритете', 'ar': 'الأرباح أولاً', 'th': 'กำไรก่อน', 'vi': 'Lợi nhuận ưu tiên', 'id': 'Untung dulu', 'hi': 'लाभ प्रथम', 'tr': 'Önce kâr'},
    'aiStrategyLossMin': {'ko': '손실 최소', 'en': 'Minimize loss', 'zh': '最小化亏损', 'ja': '損失最小', 'es': 'Minimizar pérdidas', 'fr': 'Minimiser les pertes', 'de': 'Verlust minimieren', 'pt': 'Minimizar perdas', 'ru': 'Минимизация убытков', 'ar': 'تقليل الخسائر', 'th': 'ลดการสูญเสีย', 'vi': 'Tối thiểu hóa lỗ', 'id': 'Minimalkan kerugian', 'hi': 'नुकसान कम करें', 'tr': 'Kaybı azalt'},
    'aiStrategyBalanced': {'ko': '균형', 'en': 'Balanced', 'zh': '均衡', 'ja': 'バランス', 'es': 'Equilibrado', 'fr': 'Équilibré', 'de': 'Ausgewogen', 'pt': 'Equilibrado', 'ru': 'Сбалансировано', 'ar': 'متوازن', 'th': 'สมดุล', 'vi': 'Cân bằng', 'id': 'Seimbang', 'hi': 'संतुलित', 'tr': 'Dengeli'},
    'aiStrategyEngine': {'ko': '개미엔진 판단', 'en': 'Engine decision', 'zh': '引擎判断', 'ja': 'エンジン判断', 'es': 'Decisión del motor', 'fr': 'Décision moteur', 'de': 'Engine-Entscheidung', 'pt': 'Decisão do motor', 'ru': 'Решение движка', 'ar': 'قرار المحرك', 'th': 'การตัดสินใจของเอ็นจิ้น', 'vi': 'Quyết định engine', 'id': 'Keputusan mesin', 'hi': 'इंजन निर्णय', 'tr': 'Motor kararı'},
    'aiPortfolioPreview': {'ko': '예상 배분', 'en': 'Expected allocation', 'zh': '预计分配', 'ja': '予想配分', 'es': 'Asignación prevista', 'fr': 'Répartition prévue', 'de': 'Erwartete Aufteilung', 'pt': 'Alocação prevista', 'ru': 'Ожидаемое распределение', 'ar': 'التوزيع المتوقع', 'th': 'การจัดสรรโดยประมาณ', 'vi': 'Phân bổ dự kiến', 'id': 'Alokasi perkiraan', 'hi': 'अनुमानित आवंटन', 'tr': 'Tahmini dağılım'},
    'aiPortfolioTotal': {'ko': '총 투자 금액', 'en': 'Total investment', 'zh': '总投资额', 'ja': '総投資額', 'es': 'Inversión total', 'fr': 'Investissement total', 'de': 'Gesamtinvestition', 'pt': 'Investimento total', 'ru': 'Общая сумма', 'ar': 'إجمالي الاستثمار', 'th': 'ยอดลงทุนทั้งหมด', 'vi': 'Tổng đầu tư', 'id': 'Total investasi', 'hi': 'कुल निवेश', 'tr': 'Toplam yatırım'},
  ...
  String get aiStrategyTitle => _t(_strings, 'aiStrategyTitle');
  String get aiStrategyProfitFirst => _t(_strings, 'aiStrategyProfitFirst');
  String get aiStrategyLossMin => _t(_strings, 'aiStrategyLossMin');
  String get aiStrategyBalanced => _t(_strings, 'aiStrategyBalanced');
  String get aiStrategyEngine => _t(_strings, 'aiStrategyEngine');
  String get aiPortfolioPreview => _t(_strings, 'aiPortfolioPreview');
  String get aiPortfolioTotal => _t(_strings, 'aiPortfolioTotal');
